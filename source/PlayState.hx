...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'pulse':
				dialogue = CoolUtil.coolTextFile(Paths.txt('pulse/plsSub'));
			case 'heartbreak':
				dialogue = CoolUtil.coolTextFile(Paths.txt('heartbreak/toDemisurge'));
			case 'rage':
				dialogue = CoolUtil.coolTextFile(Paths.txt('rage/andGameVasion'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'school':
			{
					...
					if (SONG.song.toLowerCase() == 'heartbreak')
						{
							if(FlxG.save.data.distractions){
								bgGirls.getScared();
							}
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		if (SONG.song.toLowerCase() == 'heartbreak' || SONG.song.toLowerCase() == 'rage')
		{
			remove(black);
